...
#define mikbanner \
"=======================================================================\n" \
"MIKMOD v2.04 - Portable version -  Programmed by MikMak of HaRDCoDE '95\n" \
"=======================================================================\n" \
...
typedef struct DRIVER {
    ...
    char *Version;
     BOOL(*IsPresent) (void);
     SWORD(*SampleLoad) (FILE * fp, ULONG size, ULONG reppos, ULONG repend,
			 UWORD flags);
    ...
    void (*VoicePlay) (UBYTE voice, SWORD handle, ULONG start, ULONG size,
...
SWORD MD_SampleLoad(FILE * fp, ULONG size, ULONG reppos, ULONG repend,
		    UWORD flags);
...
void MD_VoicePlay(UBYTE voice, SWORD handle, ULONG start, ULONG size,
		  ULONG reppos, ULONG repend, UWORD flags);
...
SWORD VC_SampleLoad(FILE * fp, ULONG size, ULONG reppos, ULONG repend,
		    UWORD flags);
...
void VC_VoicePlay(UBYTE voice, SWORD handle, ULONG start, ULONG size,
		  ULONG reppos, ULONG repend, UWORD flags);
